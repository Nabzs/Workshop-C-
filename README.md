...
| <a id="29"></a>29 | Colorer la height map (Avec génération aléatoire de taille ainsi que de disposition de map) |   ⭐⭐⭐⭐⭐⭐    | ![Exercice 29 Original](./output/DiamondSquares/DiamondSquare.png) | ![Exercice 29 Résultat](./output/DiamondSquares/DiamondSquareColored_2049.png) | ![Exercice 29 Résultat 2](./output/DiamondSquares/DiamondSquareColored_4097.png) | Ayant déjà fait de la génération procédurale en C#, cet exercice est celui où je me suis le plus amusé et où j'ai le pus appris de choses |
